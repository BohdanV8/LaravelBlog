...
@section('content')
<section class="vh-100 " style="background-color: #eee;"> <div class="container h-100"> <div class="row d-flex
    justify-content-center align-items-center h-100"> <div class="col-lg-12 col-xl-11">
    ...
    <div class="row justify-content-center">
        ...
        <form class="mx-1 mx-md-4" action="/newUser" method="post">
            @csrf
